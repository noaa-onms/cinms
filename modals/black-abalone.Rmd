...
`r infographiqR::render_figure("Figure App.F.13.2.", "../img/cinms_cr/App.F.13.2_blackabs_size.jpg")`

### Density & counts on islands

`r infographiqR::render_figure("Figure App.F.13.1.", "../img/cinms_cr/App.F.13.1_BlackAbalone_CINP.jpg")`
