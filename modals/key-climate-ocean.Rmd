...
`r onmsR::md_caption("Figure Ux.Ocean.SST.ERD.map.")`

`r onmsR::md_caption("Figure Ux.Ocean.SST.ERD.map.", get_details = T, fig_in_report = F)`
...
`r onmsR::md_caption("Figure Ux.Ocean.SST.ERD.timeseries.")`

`r onmsR::md_caption("Figure Ux.Ocean.SST.ERD.timeseries.", get_details = T, fig_in_report = F)`
...
`r onmsR::md_caption("Figure Ux.Ocean.SST.Anomaly.timeseries.")`

`r onmsR::md_caption("Figure Ux.Ocean.SST.Anomaly.timeseries.", get_details = T, fig_in_report = F)`

Download timeseries data for sanctuary: `r html_SST`

### Trend: Temperature profile (PnB)

`r onmsR::render_figure("Figure App.D.8.4.", "../img/cinms_cr/App.D.8.4.png")`
...
`r onmsR::md_caption("Figure Ux.Ocean.Chl.ERD.map.")`

`r onmsR::md_caption("Figure Ux.Ocean.Chl.ERD.map.", get_details = T, fig_in_report = F)`
...
`r onmsR::md_caption("Figure Ux.Ocean.Chl.ERD.timeseries.")`

`r onmsR::md_caption("Figure Ux.Ocean.Chl.ERD.timeseries.", get_details = T, fig_in_report = F)`
...
`r onmsR::render_figure("Figure App.D.6.5.", "../img/cinms_cr/App.D.6.5.png")`

### Trend: Phosphate profile (PnB)

`r onmsR::render_figure("Figure App.D.6.6.", "../img/cinms_cr/App.D.6.6.png")`

### Trend: Nitrate anomaly

`r onmsR::render_figure("Figure App.D.6.7.", "../img/cinms_cr/App.D.6.7_SST and nitrate anomalies 2001-2015_Reed et al._2016.jpg")`

## Basin Scale Indices
### Trend: ONI, PDO, NPGO

`r onmsR::render_figure("Figure App.D.8.3.", "../img/cinms_cr/App.D.8.3.png")`
