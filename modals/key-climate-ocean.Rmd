...
Download timeseries data for sanctuary: [`r basename(csv)`](https://github.com/marinebon/`r nms`/raw/master/data/oceano/`r basename(csv)`)

`r md_caption("Figure Ux.Ocean.SST.timeseries.")`

`r md_caption("Figure Ux.Ocean.SST.timeseries.", get_details = T)`
