...
```{r SST_map}
message("DEBUG chunk begin: SST_map")
...
message("DEBUG chunk end: SST_map")
```
...
```{r SST_time_series}
message("DEBUG chunk begin: SST_time_series")
...
`r md_caption("Figure Ux.Ocean.SST.ERD.timeseries.", get_details = T, fig_in_report = F)`
...
message("DEBUG chunk begin: sst anomaly time series")
...
message("DEBUG chunk end: sst anomaly time series")
```
