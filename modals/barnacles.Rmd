...
`r nms4r::md_caption("Acorn barnacles_all", get_details = T)`
...
`r nms4r::md_caption("Acorn barnacles", get_details = T)`
...
`r nms4r::md_caption("Gooseneck barnacles", get_details = T)`
...
`r nms4r::md_caption("Pink barnacles", get_details = T)`
